// Copyright (c) 2014 The simplecash developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("simplecash-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("simplecash-smsg-pow"); // Make this thread recognisable
