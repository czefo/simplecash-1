...
static const int LAST_POW_BLOCK = 15200;          // 15000 Blocks with Rewards
static const int LAST_FAIR_LAUNCH_BLOCK = 200;    // Start is Block 97 , so over 100 Blocks Fairlaunch
static const int LAST_POS_BLOCK_GERMINATION = LAST_POW_BLOCK;
static const int LAST_POS_BLOCK_GROWTH = LAST_POW_BLOCK + (14 * BLOCK_DAY);  // 14 Days High POS to Grow some Coins
...
static const int64_t MAX_COIN_YEAR_REWARD = 8; // 8% interest during first year of maturity period.
static const int64_t COIN_DAY_REWARD = 162 * DAYS; // 162% Daily during growth period

static const int64_t ICO = 450 * COIN;
...
static const uint256 hashGenesisBlock("0x00000bcc1f4d85319b90a2f5fe91aa3cc172204a83940edbb364fc6dbde20dfe");
