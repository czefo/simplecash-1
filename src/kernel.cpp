...
bool CheckStakeKernelHash(unsigned int nBits, const CBlock& blockFrom, unsigned int nTxPrevOffset, const CTransaction& txPrev, const COutPoint& prevout, unsigned int nTimeTx, uint256& hashProofOfStake, uint256& targetProofOfStake, bool fPrintProofOfStake)
{
    ...
    if  (pindexBest->nTime < 1480334400) // Human time (GMT): Mon, 28 Nov 2016 12:00:00 GMT
    ...
    else
    {
        ...
        int nWeightFactor;
        if (pindexBest->nTime < 1481198400) nWeightFactor = 1000;        // Human time (GMT): Thu, 08 Dec 2016 12:00:00 GMT-- Boost 1000x, Accept boosted blocks 10 minutes before wallet starts sending them.
        else if (pindexBest->nTime < 1481371200) nWeightFactor = 100;         // Human time (GMT): Sat, 10 Dec 2016 12:00:00 GMT -- Slowly Phase Out, Continue accepting 1000x for 10 minutes after wallet stops sending them.
        else if (pindexBest->nTime >= 1481371200) nWeightFactor = 10;         // Human time (GMT): Sat, 10 Dec 2016 12:00:00 GMT -- Phase out to 10x weight, Continue accepting 100x for 10 minutes after wallet stops sending them.
