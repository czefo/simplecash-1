...
Section -post SEC0001
    ...
    CreateDirectory $simpROGRAMS\$StartMenuGroup
    CreateShortcut "$simpROGRAMS\$StartMenuGroup\Uninstall NovaCoin.lnk" $INSTDIR\uninstall.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$simpROGRAMS\$StartMenuGroup\Uninstall NovaCoin.lnk"
    #Delete /REBOOTOK "$simpROGRAMS\$StartMenuGroup\Bitcoin.lnk"
    ...
    RmDir /REBOOTOK $simpROGRAMS\$StartMenuGroup
